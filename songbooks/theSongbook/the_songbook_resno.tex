...
\newindex{mainidx}{mainidxfilee}
\newauthorindex{authidx}{authidxfilee}
...
\newcommand{\imesomentorja}{Joško} % akademski naziv in ime somentorja
\newcommand{\naslovdela}{Song buk}
...
\begin{center}
	...
	\textbf{\MakeUppercase{\naslovdela}}\\[10mm]
	\large
	elektronska različica \\[1cm]
\end{center}
\vfill

\noindent{\large Širni splet, \letnica}
...
\section*{\naslovdela}
Letnik II, številka $1$, prvi ponatis

\section*{Avtorja komadov}
Slon~in~Sadež

\section*{Zapisal in priredil}
Ivo

\section*{Urednica}
Katja

\section*{Izognil se Wordu}
Matej

\section*{Lektura}
Preberite stran ali dve in videli boste \dots

\section*{Oblikovanje}
\LaTeX

\section*{Tisk}
ni več potreben. Prosimo, pomislite na okolje, preden natisnete to delo. Severni medvedi stradajo.
...
\showindex[1]{Kazalo pesmi}{mainidx}
\showindex[1]{Kazalo avtorjev}{authidx}
